...
import Manal from './Manal Almakhlafi.pdf'
...
const darkMode = theme.state.darkMode;
  ...
  return (
    ...
    >Manal Mohammed Almakhlafi</span>
        <span>Advertising and Marketing Communication Student</span>
        <span><div className="headerProfile-menu-list" onClick={() => window.open(Manal)}><i className="mdi mdi-help-circle"></i> <button  className='button s-button'>CV</button></div></span>
